...
<table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    <thead>
        <tr>
            ...
            <th width="16%"><a <?php echo $login_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=login"><?php echo __('Last Login');?></a></th>
            <th width="14%"><a <?php echo $created_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=created"><?php echo __('Created');?></a></th>
            <th width="10%"><a  <?php echo $status_sort; ?> href="directory.php?<?php echo $qstr; ?>&sort=status"><?php echo __('Status');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        foreach ($agents as $A) { ?>
           <tr id="<?php echo $A->staff_id; ?>">
                ...
                <td><?php echo Format::relativeTime(Misc::db2gmtime($A->lastlogin)) ?: '<em class="faded">'.__('never').'</em>'; ?></td>
                <td><?php echo Format::date($A->created); ?></td>
                <td><?php echo $A->isActive() ? __('Active') :'<b>'.__('Locked').'</b>'; ?><?php
                    echo $A->onvacation ? ' <small>(<i>'.__('vacation').'</i>)</small>' : ''; ?></td>
           </tr>
            <?php
            } // end of foreach
        ?>
